...
export default function ConceptEightyNine({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Compassion mantras are short phrases that retrain inner speech toward steadiness and care.',
    'Repeated with breath, they interrupt reflexive judgment and reduce emotional escalation.',
    'Mantras become powerful when practiced before crisis, not only during it.',
    'Consistent compassionate language improves both self-regulation and relationship quality.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module23Progress step={1} label="Compassion Mantras" />
      <LyricalAnchor line={module23LyricLines.concept89} targetTime={module23LyricTimings.concept89} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-emerald-100/80">Concept 89 // Compassion Mantras</p>
