...
export default function ConceptFortyTwo({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Orgone energy, in modern practice, points to felt vitality and somatic aliveness.',
    'When tension is chronic, perception narrows. When tension softens, cognition and empathy reopen.',
    'Breath, posture, and micro-movements are levers for restoring energetic flow.',
    'A crystal mind needs a body that is not locked in armor.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-neutral-200 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module11Progress step={2} label="Orgone Energy" />
      <LyricalAnchor line={module11LyricLines.concept42} targetTime={module11LyricTimings.concept42} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-sky-100/80">Concept 42 // Orgone Energy</p>
