...
export default function ModuleSeventeenBackdrop() {
  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 18% 20%, rgba(139,92,246,0.2), transparent 45%), radial-gradient(circle at 78% 72%, rgba(168,85,247,0.16), transparent 52%), linear-gradient(to bottom, rgba(34,17,63,0.72), rgba(2,6,23,0.92))',
        }}
      />
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {particles.map((particle) => (
          <span
            key={particle.id}
            className="absolute rounded-full bg-violet-200/85 animate-pulse"
            style={{
              left: particle.left,
              top: particle.top,
              width: particle.size,
