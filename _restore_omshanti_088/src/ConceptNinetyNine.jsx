...
export default function ConceptNinetyNine({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Mirror mantras use reflection to pair truthful self-recognition with compassionate direction.',
    'The mirror prevents abstraction by grounding language in immediate embodiment.',
    'You name what is real while choosing what you are becoming.',
    'This practice strengthens accountability without harsh self-attack.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module25Progress step={3} label="Mirror Mantras" />
      <LyricalAnchor line={module25LyricLines.concept99} targetTime={module25LyricTimings.concept99} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-fuchsia-100/80">Concept 99 // Mirror Mantras</p>
