...
export default function ConceptFortyFive({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Pranic breathing is energy management through deliberate respiration.',
    'Each slow inhale expands your available attention; each complete exhale discharges noise.',
    'The goal is not theatrical breathwork. The goal is reliable regulation under pressure.',
    'Count your breath like a metronome for consciousness.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-neutral-200 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module12Progress step={1} label="Pranic Breathing" />
      <LyricalAnchor line={module12LyricLines.concept45} targetTime={module12LyricTimings.concept45} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-amber-100/80">Concept 45 // Pranic Breathing</p>
