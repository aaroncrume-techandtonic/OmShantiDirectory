...
export default function ConceptNinetyFive({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Crystal water practice uses intention and ritual attention to improve hydration awareness.',
    'The vessel becomes a behavioral anchor for gratitude and embodied presence.',
    'When paired with breath, water rituals can reset pace and mood quickly.',
    'Meaningful repetition turns hydration into a coherence practice.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module24Progress step={3} label="Crystal Water" />
      <LyricalAnchor line={module24LyricLines.concept95} targetTime={module24LyricTimings.concept95} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-sky-100/80">Concept 95 // Crystal Water</p>
