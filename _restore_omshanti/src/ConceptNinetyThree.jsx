...
export default function ConceptNinetyThree({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Tonal tapping combines rhythm and gentle touch to regulate stress and restore focus.',
    'Repetitive tapping patterns can calm overactive loops in the nervous system.',
    'The tone gives structure while the body learns safety through repetition.',
    'Simple daily tapping sequences improve emotional recovery speed.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module24Progress step={1} label="Tonal Tapping" />
      <LyricalAnchor line={module24LyricLines.concept93} targetTime={module24LyricTimings.concept93} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-sky-100/80">Concept 93 // Tonal Tapping</p>
