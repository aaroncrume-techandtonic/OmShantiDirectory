...
export default function ConceptSeventyEight({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Third eye softening reduces forceful concentration and invites receptive perception.',
    'You ease the forehead, eyes, and breath so intuition can emerge without strain.',
    'This is not dissociation. It is calm attentiveness to subtler signals in real time.',
    'Soft focus often reveals options that rigid analysis overlooks.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module20Progress step={2} label="Third Eye Softening" />
      <LyricalAnchor line={module20LyricLines.concept78} targetTime={module20LyricTimings.concept78} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-rose-100/80">Concept 78 // Third Eye Softening</p>
