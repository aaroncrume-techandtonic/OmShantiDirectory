...
export default function ConceptFortyEight({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Synchronicity tracking is disciplined pattern observation without superstition spirals.',
    'You record meaningful coincidences, emotional context, and resulting decisions.',
    'Over time, patterns reveal what your attention repeatedly avoids or seeks.',
    'Use synchronicity as a mirror for alignment, not as permission to abandon discernment.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-neutral-200 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module12Progress step={4} label="Synchronicity Tracking" />
      <LyricalAnchor line={module12LyricLines.concept48} targetTime={module12LyricTimings.concept48} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-amber-100/80">Concept 48 // Synchronicity Tracking</p>
