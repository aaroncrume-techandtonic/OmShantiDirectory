...
export default function ConceptNinetySix({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Solar charging aligns daily behavior with light cycles to support alertness and recovery.',
    'Morning light helps stabilize circadian rhythm and improves downstream sleep quality.',
    'Charging is practical: brief, consistent exposure outperforms sporadic intensity.',
    'When light habits are deliberate, cognition and mood become more predictable.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module24Progress step={4} label="Solar Charging" />
      <LyricalAnchor line={module24LyricLines.concept96} targetTime={module24LyricTimings.concept96} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-sky-100/80">Concept 96 // Solar Charging</p>
