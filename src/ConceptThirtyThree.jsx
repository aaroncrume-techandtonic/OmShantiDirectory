...
export default function ConceptThirtyThree({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Sacred geometry is pattern literacy for consciousness.',
    'When you contemplate stable forms, your attention shifts from scattered reaction into coherent orientation.',
    'These symbols are not decoration; they are cognitive anchors for order, proportion, and rhythm.',
    'Study one shape deeply and let it teach your nervous system consistency.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-neutral-200 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      <ModuleNineBackdrop />
      <Module9Progress step={1} label="Sacred Geometry" />
      <LyricalAnchor line={module9LyricLines.concept33} targetTime={module9LyricTimings.concept33} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-fuchsia-100/80">Concept 33 // Sacred Geometry</p>
