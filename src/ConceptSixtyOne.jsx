...
export default function ConceptSixtyOne({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Elemental grounding reconnects you with earth, air, fire, and water as regulatory anchors.',
    'Each element represents a different quality of balance you can evoke on purpose.',
    'Grounding is not abstract. It is sensory contact with what stabilizes your body now.',
    'Return to the elements, and scattered attention starts to organize itself.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-neutral-200 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module16Progress step={1} label="Elemental Grounding" />
      <LyricalAnchor line={module16LyricLines.concept61} targetTime={module16LyricTimings.concept61} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-orange-100/80">Concept 61 // Elemental Grounding</p>
