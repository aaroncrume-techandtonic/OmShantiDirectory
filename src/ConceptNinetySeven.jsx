...
export default function ConceptNinetySeven({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Ancestral light reframes lineage as transmitted resilience, wisdom, and unfinished healing work.',
    'You honor inherited gifts while consciously transforming inherited pain.',
    'Remembering lineage can produce grounded gratitude without romanticizing the past.',
    'Ancestral awareness supports responsibility, humility, and continuity.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-slate-100 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module25Progress step={1} label="Ancestral Light" />
      <LyricalAnchor line={module25LyricLines.concept97} targetTime={module25LyricTimings.concept97} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-fuchsia-100/80">Concept 97 // Ancestral Light</p>
