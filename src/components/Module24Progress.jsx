...
export default function Module24Progress({ step, total = 5, label }) {
  ...
  return (
    ...
    >
      <p className="text-[10px] uppercase tracking-[0.22em] text-sky-100/80 mb-2">
        Module 24 // {label}
      </p>
      <div className="h-[2px] w-full bg-sky-950/70 overflow-hidden rounded-full">
        <motion.div
          ...
          className="h-full bg-sky-300/90"
        />
      </div>
