...
export default function Module14Progress({ step, total = 5, label }) {
  ...
  return (
    ...
    >
      <p className="text-[10px] uppercase tracking-[0.22em] text-cyan-100/80 mb-2">
        Module 14 // {label}
      </p>
      ...
      <p className="mt-2 text-[10px] text-cyan-100/80 tracking-[0.18em] uppercase">
