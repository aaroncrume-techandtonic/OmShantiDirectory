...
export default function ConceptFortySix({ onContinue }) {
  ...
  const scriptParagraphs = [
    'Non-attachment is full participation without identity fusion.',
    'You can care deeply while refusing to let outcomes define your worth.',
    'This stance protects clarity: act fully, release grasping, adapt quickly.',
    'Watch the world, but do not stay trapped in any single frame.',
  ];
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-slate-950 text-neutral-200 flex flex-col items-center justify-center p-6 sm:p-12 font-sans">
      ...
      <Module12Progress step={2} label="Non-Attachment" />
      <LyricalAnchor line={module12LyricLines.concept46} targetTime={module12LyricTimings.concept46} />

      <motion.div className="relative max-w-3xl space-y-7 text-base sm:text-lg leading-relaxed text-center" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1 }}>
        <p className="text-xs uppercase tracking-[0.24em] text-amber-100/80">Concept 46 // Non-Attachment</p>
